...
/***
 * UserDA this class used to connect student with the database
...
public class UserDA 
{
	...
	// declare static variables for all Users instance attribute values
			...
			/**
			 * static variable year as integer
			 */
			static int year;
			...
			/**
			 * static variable enroleDate as a Date
			 */
			...
			/**
			 * initialize to initialize connection with the database
			 * @param c
			...
			/**
			 * terminate to close the connection 
			 * @throws SQLException
			 * @exception SQLException
			...
			/**
			 * retrieve this method use to call the user data from the database
			 * @param key
			 * @return aUser object of the User class
			...
			// first create a user 
			/**
			 * create this method used to create a user in database
			 * while they register
			 * @param aStudent
			 * @return result as a boolean it send true if created otherwise false
			 * @throws NotFoundException
			 * @throws InvalidIdException
			 * @throws InvalidNameException
			 * @throws NotFoundException
