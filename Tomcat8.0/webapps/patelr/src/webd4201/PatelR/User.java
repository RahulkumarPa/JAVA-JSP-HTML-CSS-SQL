...
public class  User implements  CollegeInterface
{
	 public static final long DEFAULT_ID = 100123456L;
	    ...
	    /**
	     * MINIMUM_PASSWORD_LENGTH static and by default length is 8
	     */
	    public static final byte MINIMUM_PASSWORD_LENGTH = 8;
	    /**
	     * MAXIMUM_PASSWORD_LENGTH static and by default length is 20
	     */
	  ...
	  public User()throws InvalidUserDataException
	    ...
	    /**
	     * setLastAccess
	     * @param lastAccess set lastAcsess
	     */
	    ...
	    /**
	     * retrieve call the retrieve methods from the UserDA
	     * @param key
	     * @return
    ...
    **/
	public  String toString()
	    ...
	    public void displayToConsole()
	   {
	    ...
	    /**
	     * verifyPassword certify password length
	     * @param pd string
	     * @return ans as a boolean
	     */
	    ...
	    public String getTypeforDisplay()
	   {
	    ...
	    /**
	     * decToHex to provide a security to password
	     * @param bytes data type bytes
	    ...
	    /**
	     * hash call the string password which we have to hash
	     * @param thingToBeHashed string 
	     * @return has as a string after hashed
	     * @throws NoSuchAlgorithmException not a algorithm
	     */
		...
		/**
		 * @param email string came from the set methd
