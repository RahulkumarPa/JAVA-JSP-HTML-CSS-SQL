...
//		    	System.out.println(UserDA.create(mainStudent));
...
//		    }
		    ...
		    try // now, attempt to login
		    {
		    	...
		    	System.out.println("\nAttempt to login the student record for " + id + "("+hashedPassword+")");
			   		...
			   		System.out.println("hiiiiiii" +loginuser.getYear()+ "seee");
			   		System.out.println("******************************");
			   		System.out.println(loginuser.getYear());
			   		mainStudent.setId(100111111);
			   		mainStudent.setFirstName("gopal");
			   		mainStudent.setLastName("ja");
			   		mainStudent.setEmailAddress("jai@gmail.com");
			   		mainStudent.updateTermTest();
			   		mainStudent.displayToConsole();
			   		System.out.println("Student record updated in the database.\n");
